...
const Photo_Gallery = () => {
  ...
  return (
    <div className="Photo_Gallery-Aishwaryas-Function">
        <div className="gold-text">
            <br />
            <br />
            <h2>Our Gallery</h2>

            <div className="Pictures-Aishwaryas-Function">
                <LightGallery
                speed={500}
            ...
            >
                {
                    data.map((item,index) => {
                        return(
                            <a className='Pics-Aishwaryas-Function' href={item.imgsrc} key={index}>
