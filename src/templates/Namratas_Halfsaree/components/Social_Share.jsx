...
const Social_Share = () => {
  ...
  return (
    <div className="Social_Share-Namratas-Function">
        <h2>Social Share</h2>
        <div className="Media-Namratas-Function">
        ...
        <div className="Footer-Namratas-Function">
        <h3>InviteDigitly</h3> <br />
        <div className="Footer-row-Namratas-Function">
